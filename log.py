...
class Log:
    ...
    def log_record_entry(self,info):
        ...
        sheet.update_cell(1,3,'time logged') 
        sheet.update_cell(1,4,'logged in or out') 
        sheet.update_cell(1,5,'device id')  
        ...
        sheet.append_row([device_name,info,dt,'logged in',device_id])
        
    def log_record_exit(self,info):
        ...
        sheet.append_row([device_name,info,dt,'logged out',device_id])
